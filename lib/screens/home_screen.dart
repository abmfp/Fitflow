...
class _HomeScreenState extends State<HomeScreen> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // --- Apply animation to the workout card ---
                ...
                // --- Apply animation to the first info card ---
                _buildInfoCard(
                  context,
                 ...
                 .fadeIn(duration: 500.ms, delay: 200.ms) // Add a delay
                 .slideY(begin: 0.2, end: 0),

                const SizedBox(height: 16),

                // --- Apply animation to the second info card ---
                _buildInfoCard(
                  context,
                 ...
                 .fadeIn(duration: 500.ms, delay: 400.ms) // Add a longer delay
                 .slideY(begin: 0.2, end: 0),
              ],
            ),
          ),
  ...
  // ... (the rest of your HomeScreen's helper functions remain the same)
